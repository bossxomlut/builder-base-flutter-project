                    ...
                    child: Column(
                      children: [
                        ...
                        OutlineField(
                          ...
                          value: landCertificateEntity.district?.name ?? nullPlaceHolder,
                          onTap: () {},
                          showTrailingIcon: false,
                        ),
                        const Gap(16),
                        OutlineField(
                          ...
                          value: landCertificateEntity.ward?.name ?? nullPlaceHolder,
                          onTap: () {},
                          showTrailingIcon: false,
                        ),
                        const Gap(16),
                        CustomTextField(
                          isReadOnly: true,
                          initialValue: landCertificateEntity.detailAddress.displayFormat,
                          onChanged: (value) {},
                    ...
                    child: Column(
                      children: [
                        OutlineField(
                          ...
                          value: landCertificateEntity.purchaseDate.dateDisplace,
                          onTap: () async {},
                    ...
                    child: Column(
                      children: [
                        OutlineField(
                          ...
                          value: landCertificateEntity.saleDate.dateDisplace,
                          trailing: const Icon(Icons.calendar_today_outlined),
                          onTap: () async {},
                        ),
                        const Gap(16),
                    ...
                    child: Column(
                      children: [
                        ...
                        CustomTextField(
                          ...
                          initialValue: landCertificateEntity.useType.displayFormat,
                        ),
                        const Gap(16),
                        CustomTextField(
                          isReadOnly: true,
                          ...
                          initialValue: landCertificateEntity.purpose.displayFormat,
                        ),
                      ],
                    ),
                  ),
                    ...
                    child: Column(
                      children: [
                        CustomTextField(
                          ...
                          initialValue: landCertificateEntity.note.displayFormat,
                        ),
                      ],
                    ),
                  ),
